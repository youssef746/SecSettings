...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/settings/wifi/SetupWizardWifiScreen;->POPUP_ACTIVITY_CLASS_NAME:Ljava/lang/String;

    .line 33
    const-string v0, "com.sec.android.app.setupwizard"

    iput-object v0, p0, Lcom/android/settings/wifi/SetupWizardWifiScreen;->POPUP_ACTIVITY_PACKAGE_NAME:Ljava/lang/String;

    .line 37
    const-string v0, "setup_wizard_bundle"

    iput-object v0, p0, Lcom/android/settings/wifi/SetupWizardWifiScreen;->KEY_SETUPWIZARD_BUNDLE:Ljava/lang/String;

    .line 39
    const/4 v0, 0x0

    iput-object v0, p0, Lcom/android/settings/wifi/SetupWizardWifiScreen;->mBundleExtras:Landroid/os/Bundle;

    return-void
.end method

.method static synthetic access$000(Lcom/android/settings/wifi/SetupWizardWifiScreen;)V
    .locals 0
    .parameter "x0"

    .prologue
    .line 28
    invoke-direct {p0}, Lcom/android/settings/wifi/SetupWizardWifiScreen;->launchHomeScreen()V
...
.method private initializeView()V
    ...
    .line 68
    invoke-virtual {p0}, Lcom/android/settings/wifi/SetupWizardWifiScreen;->getLayoutInflater()Landroid/view/LayoutInflater;
    ...
    .line 79
    iget-object v9, p0, Lcom/android/settings/wifi/SetupWizardWifiScreen;->mStepIndicator:Ljava/lang/String;
    ...
    invoke-virtual {p0, v9}, Lcom/android/settings/wifi/SetupWizardWifiScreen;->findViewById(I)Landroid/view/View;
    ...
    new-instance v9, Lcom/android/settings/wifi/SetupWizardWifiScreen$1;

    invoke-direct {v9, p0}, Lcom/android/settings/wifi/SetupWizardWifiScreen$1;-><init>(Lcom/android/settings/wifi/SetupWizardWifiScreen;)V
    ...
    new-instance v9, Lcom/android/settings/wifi/SetupWizardWifiScreen$2;

    invoke-direct {v9, p0}, Lcom/android/settings/wifi/SetupWizardWifiScreen$2;-><init>(Lcom/android/settings/wifi/SetupWizardWifiScreen;)V
...
.method private launchHomeScreen()V
    ...
    .line 170
    invoke-virtual {p0, v0}, Lcom/android/settings/wifi/SetupWizardWifiScreen;->startActivity(Landroid/content/Intent;)V
...
.method private updateLayoutMargin(Landroid/content/res/Configuration;)V
    ...
    invoke-virtual {p0, v2}, Lcom/android/settings/wifi/SetupWizardWifiScreen;->findViewById(I)Landroid/view/View;
...
.method public onBackPressed()V
    ...
    iget-object v1, p0, Lcom/android/settings/wifi/SetupWizardWifiScreen;->mBackwardIntent:Ljava/lang/String;

    invoke-direct {v0, v1}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    .line 116
    .local v0, intent:Landroid/content/Intent;
    iget-object v1, p0, Lcom/android/settings/wifi/SetupWizardWifiScreen;->mBundleExtras:Landroid/os/Bundle;
    ...
    iget-object v2, p0, Lcom/android/settings/wifi/SetupWizardWifiScreen;->mBundleExtras:Landroid/os/Bundle;
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    .line 140
    invoke-direct {p0, p1}, Lcom/android/settings/wifi/SetupWizardWifiScreen;->updateLayoutMargin(Landroid/content/res/Configuration;)V
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v1}, Lcom/android/settings/wifi/SetupWizardWifiScreen;->setRequestedOrientation(I)V

    .line 51
    :cond_0
    const v1, 0x7f040128

    invoke-virtual {p0, v1}, Lcom/android/settings/wifi/SetupWizardWifiScreen;->setContentView(I)V
    ...
    iput-object v1, p0, Lcom/android/settings/wifi/SetupWizardWifiScreen;->mBundleExtras:Landroid/os/Bundle;
    ...
    iput-object v1, p0, Lcom/android/settings/wifi/SetupWizardWifiScreen;->mStepIndicator:Ljava/lang/String;
    ...
    iput-object v1, p0, Lcom/android/settings/wifi/SetupWizardWifiScreen;->mForwardIntent:Ljava/lang/String;
    ...
    iput-object v1, p0, Lcom/android/settings/wifi/SetupWizardWifiScreen;->mBackwardIntent:Ljava/lang/String;
    ...
    invoke-direct {p0, v1}, Lcom/android/settings/wifi/SetupWizardWifiScreen;->updateLayoutMargin(Landroid/content/res/Configuration;)V
